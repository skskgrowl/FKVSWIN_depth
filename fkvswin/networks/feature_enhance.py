...
if __name__ == '__main__':
    model = FENeck(in_channels=[192, 384, 768, 1536], out_channels=[192, 384, 768, 1536],embedding_dim=256)

    x1 = torch.rand(2, 192, 22, 44)
    x2 = torch.rand(2, 384, 22, 44)
    x3 = torch.rand(2, 768, 22, 44)
    x4 = torch.rand(2, 1536, 22, 44)
    x=[]
    x.append(x1)
    x.append(x2)
    x.append(x3)
